                        ...
                        <div className="card info-card h-100 shadow">
                            <div className="card-body p-4">
                                ...
                                <p className="mb-3">
                                    ...
                                    <a href="tel:+1234567890" className="text-warning text-decoration-none">
                                        +1 (234) 567-890
                                    </a>
                                </p>
                                <p className="mb-0">
                                    <strong>📧 Email:</strong><br />
                                    <a href="mailto:info@xceed.com" className="text-warning text-decoration-none">
                                        info@xceed.com
                                    </a>
                                </p>
                            </div>
                        ...
                        <div className="card h-100" style={{ backgroundColor: '#3a3f47', border: 'none' }}>
                            <div className="card-body p-4">
                                ...
                                <ul className="list-unstyled mb-0">
                                    <li className="mb-2"><strong>Monday - Thursday:</strong> Closed</li>
                                    <li className="mb-2"><strong>Friday:</strong> 10:00 PM - 5:00 AM</li>
                                    <li className="mb-2"><strong>Saturday:</strong> 10:00 PM - 6:00 AM</li>
                                    <li className="mb-0"><strong>Sunday:</strong> Closed</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card h-100" style={{ backgroundColor: '#3a3f47', border: 'none' }}>
                            <div className="card-body p-4">
                                ...
                                <div className="d-flex flex-column gap-3">
                                    <a
                                        href="https://instagram.com/xceed"
                                        target="_blank"
