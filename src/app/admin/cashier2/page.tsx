...
export default function Cashier2Page() {
    ...
    useEffect(() => {
        ...
        if (adminAuth === 'true' && adminRole === 'cashier2') {
    ...
    return (
        <div className="vh-100 d-flex flex-column bg-light">
            ...
            <div className="flex-grow-1 d-flex flex-column flex-md-row overflow-hidden">
                {/* LEFT SIDE - Menu */}
                <div className="col-12 col-md-6 d-flex flex-column overflow-hidden p-3 border-end">
                    <div className="row row-cols-2 row-cols-sm-3 row-cols-lg-3 g-2 g-sm-3 flex-grow-1" style={{ margin: 0 }}>
                ...
                <div className="col-12 col-md-6 d-flex flex-column bg-white overflow-hidden">
                    ...
                    <div className="border-top p-4 bg-light">
                        <div className="d-flex align-items-center gap-3 mb-2">
                            <h2 className="mb-0 text-success flex-shrink-0">€{calculateTotal().toFixed(2)}</h2>
                            <button
